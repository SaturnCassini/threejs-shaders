...
}`,l=s=>({value:s});class J extends k{get time(){return this.uniforms.time.value}set time(e){this.uniforms.time.value=e}get radius(){return this.uniforms.radius.value}set radius(e){this.uniforms.radius.value=e}get color1(){return this.uniforms.color1.value}set color1(e){this.uniforms.color1.value.set(e)}get color2(){return this.uniforms.color2.value}set color2(e){this.uniforms.color2.value.set(e)}constructor(e){super({uniforms:{radius:l((e==null?void 0:e.radius)??10),time:l(0),color1:l(new R((e==null?void 0:e.color1)??8167403)),color2:l(new R((e==null?void 0:e.color2)??14280188)),angle:l((e==null?void 0:e.angle)??0),seed:l((e==null?void 0:e.seed)??Date.now())},vertexShader:_,fragmentShader:B,glslVersion:A})}}class Q extends r{constructor(e){super(new a(e),new J),console.dir(this.material.uniforms)}update(e){this.material.time=e/1e3}}const i=new V(70,window.innerWidth/window.innerHeight,.01,50);i.position.z=3;i.position.y=0;const f=new j,o=new Q(1);f.add(o);const T=new N(1.2,2,50),X=new c({side:U}),z=new r(T,X);z.rotation.x=1.7;const w=new d;w.add(z);o.add(w);i.lookAt(o.position);const Y=new a(.1,32,32),Z=new c,G=new r(Y,Z);G.position.set(3,0,0);const p=new d;p.add(G);o.add(p);const $=new a(.4,32,32),ee=new c,E=new r($,ee);E.position.set(6,0,0);const y=new d;y.add(E);o.add(y);const te=new a(.2,32,32),ne=new c,L=new r(te,ne);L.position.set(8,0,0);const g=new d;g.add(L);o.add(g);const oe=new a(.3,32,32),ie=new c,D=new r(oe,ie);D.position.set(10,0,0);const b=new d;b.add(D);o.add(b);const re=new a(.2,32,32),se=new c,O=new r(re,se);O.position.set(12,0,0);const x=new d;x.add(O);o.add(x);const ae=new a(.2,32,32),ce=new c,C=new r(ae,ce);C.position.set(14,0,0);const M=new d;M.add(C);o.add(M);const m=new H({antialias:!0});m.setSize(window.innerWidth,400);m.setAnimationLoop(de);window.addEventListener("resize",le,!1);const S=new q(m);S.addPass(new F(f,i));const u=new I(m," .-+*%@",{invert:!0});u.setSize(window.innerWidth,window.innerHeight);u.domElement.style.color="lightgreen";u.domElement.style.backgroundColor="black";document.body.appendChild(u.domElement);const v=new K(i,u.domElement);v.enableDamping=!0;v.dampingFactor=.05;v.maxDistance=15;v.minDistance=3;function de(s){o.update(s),S.render(s),p.rotation.y+=.02,y.rotation.y+=.01,g.rotation.y+=.03,b.rotation.y+=.02,x.rotation.y+=.01,M.rotation.y+=.03,w.rotation.y+=.005,f.rotation.y+=5e-4,u.render(f,i)}function le(){i.aspect=window.innerWidth/400,i.updateProjectionMatrix(),S.setSize(window.innerWidth,400)}
